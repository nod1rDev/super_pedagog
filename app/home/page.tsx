...
export default function HomePage() {
  ...
  const quickStats = useMemo(
    ...
    [
      articlesMeta?.count,
      booksMeta?.count,
      competitionsMeta?.count,
      methodologiesMeta?.count,
      videosMeta?.count,
    ]
  );
  ...
  const featuredContent = useMemo(() => {
    ...
    if (competitions?.[0]) {
      ...
      featured.push({
        ...
        title: comp.title,
        description:
          comp.description || "Tanlovda ishtirok eting va sovrin yutib oling",
        deadline: comp.end_date
          ? new Date(comp.end_date).toLocaleDateString("uz-UZ")
          : "Muddatsiz",
    ...
    if (books?.[0]) {
      ...
      featured.push({
        ...
        title: book.title,
        description:
          book.description || "Kitobni o'qing va bilimingizni oshiring",
        pages: book.pages || 0,
        rating: 4.8,
