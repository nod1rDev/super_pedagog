          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm opacity-90">Toshkent Davlat Pedagogika Universiteti</p>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <span className="text-sm text-muted-foreground">
                  {theme === "system" ? "Avtomatik" : isDark ? "Qorong'u" : "Yorug'"}
                </span>
                <Switch
                  checked={isDark}
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center gap-2">
                <span className="text-sm font-medium text-foreground">
                  {theme === "system" ? "Tizim" : isDark ? "Qorong'u" : "Yorug'"}
                </span>
        ...
        <Card>
          <CardContent className="p-6 text-center space-y-4">
            ...
            <div className="pt-2 border-t">
              <p className="text-xs text-muted-foreground">© 2024 Super Pedagog. Barcha huquqlar himoyalangan.</p>
            </div>
          </CardContent>
        </Card>
      </motion.section>
